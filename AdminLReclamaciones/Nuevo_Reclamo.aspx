<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Nuevo_Reclamo.aspx.vb" Inherits="AdminLReclamaciones.Nuevo_Reclamo" %>
		...
		<script>
           ...
           <%-- function adjuntar() {
            ...
            if (!allowedExtensions.exec(filePath)) {
                /*alert('Por favor, seleccione un archivo en formato JPG o JPEG.');*/
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-xxl d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center">
								<!--begin::Title-->
								<h3 class="text-dark fw-bolder my-1 fs-2">Nuevo Reclamo Físico</h3>
								<!--end::Title-->
							</div>
														...
														<div class="row">
															...
															<div class="col-lg-6">
																<div class="card shadow-sm">
																	<div class="card-body">
																		<h6 class="" style="color: #860264">¿Es un documento Anulado?</h6>
																		<br />
																		<p class="text-muted">En caso que el consumidor no consigne como mínimo su nombre, DNI, domicilio o correo electrónico, fecha del reclamo o queja y el detalle de los mismos, estos se consideraran como no presentados.</p>
																		
																		<div class="form-group" >
																			<asp:UpdatePanel ID="UpdatePanelanul_fisico" runat="server">
																			<ContentTemplate>
																			<asp:CheckBox ID="chkanulado_fisico" runat="server" Text="Documento Anulado" CssClass="custom-checkbox-list"/>
																			</ContentTemplate>
																			</asp:UpdatePanel>
                                                       					</div>   
																		...
																		<br />
																		 <div class="form-group">
																				<label><b>Ingrese el sustento de anulación:</b></label>
																				<asp:UpdatePanel ID="UpdatePanel4" runat="server">
																					<ContentTemplate>
																							  <asp:TextBox ID="txtsustentoanulacion" runat="server" class="form-control" AutoPostBack="True" TextMode="MultiLine" Rows="4" MaxLength="500"></asp:TextBox>
																					</ContentTemplate>
																...
																<div class="card shadow-sm">
																	<div class="card-body">
																		<h6 class="" style="color: #860264">Ingrese en Número de Reclamo</h6>
																		<br />
																		<label>Número de Reclamo Físico(*):</label>
                                                  								<asp:TextBox ID="txtNroFisico" runat="server" class="form-control"></asp:TextBox>
																		<br />
																		<label>Fecha de Reclamo Físico(*):</label>
																				<asp:TextBox ID="txtFechaDocumento" runat="server" class="form-control" type="date"></asp:TextBox>
																	</div>
																</div>
																...
																<div class="card shadow-sm">
																	<div class="card-body">
																		<h6 class="" style="color: #860264">Datos del local de atención</h6>
																		<br />
																		<label>Seleccione Marca:</label>
																				<asp:UpdatePanel ID="UpdatePanel7" runat="server">
																				<ContentTemplate>
                                                  								<asp:DropDownList ID="cbomarca" runat="server" class="form-select" AutoPostBack="True"></asp:DropDownList>
																				</ContentTemplate>
																				</asp:UpdatePanel>
																		<br />
																		<label>Seleccione Local:</label>
																				...
																				<ContentTemplate>
                                                  								<asp:DropDownList ID="cbolocal" runat="server" class="form-select"></asp:DropDownList>
																				</ContentTemplate>
																				</asp:UpdatePanel>
																	</div>
																</div>
																...
																<div class="card shadow-sm">
																	<div class="card-body">
																		<h6 class="" style="color: #860264">Datos del consumidor</h6>
																		<br />
																		<label>Nombre(*):</label>
																		...
																		<label>Distrito:</label>
                                                  								<asp:DropDownList ID="cbodistrito" runat="server" class="form-select"></asp:DropDownList>
																		<br />
																		<label>Domicilio(s)(*):</label>
																		...
																		<br />
																		<div class="form-group">
																				<label>Nombre del Padre o madre (En caso de menor de edad) - Nombre/Domicilio/Teléfono/Correo :</label>
																				<asp:UpdatePanel ID="UpdatePanel8" runat="server">
																					<ContentTemplate>
																							  <asp:TextBox ID="txtNombrePadre" runat="server" class="form-control" AutoPostBack="True" TextMode="MultiLine" Rows="4" MaxLength="500"></asp:TextBox>
																					</ContentTemplate>
															...
															<div class="col-lg-6">
																...
																<div class="card shadow-sm">
																	<div class="card-body">
																		<h6 class="" style="color: #860264">Adjuntar hoja de relamación física ("Archivo de Imagen")</h6>
																		<br />
																...
																<div class="card shadow-sm">
																	<div class="card-body">
																		<h6 class="" style="color: #860264">Detalle de Reclamación</h6>
																			<br />
																			<label>Seleccione(*):</label>
																				<asp:UpdatePanel ID="UpdatePanel11" runat="server">
																				<ContentTemplate>
                                                  								<asp:DropDownList ID="cboquejareclamo" runat="server" class="form-select"></asp:DropDownList>
																				</ContentTemplate>
																				</asp:UpdatePanel>
																			...
																			<div class="form-group">
																				...
																				<asp:UpdatePanel ID="UpdatePanel9" runat="server">
																					<ContentTemplate>
																							  <asp:TextBox ID="txtDetalle" runat="server" class="form-control" TextMode="MultiLine" Rows="4" MaxLength="500"></asp:TextBox>
																					</ContentTemplate>
																			...
																			<label>Bien Contratado(*):</label>
																				...
																				<ContentTemplate>
                                                  								<asp:DropDownList ID="cboproducto_servicio" runat="server" class="form-select"></asp:DropDownList>
																				</ContentTemplate>
																				</asp:UpdatePanel>
																			<br />
																			...
																			<div class="form-group">
																				<label>Descripción del producto o servicio reclamado: :</label>
																				<asp:UpdatePanel ID="UpdatePanel1" runat="server">
																					<ContentTemplate>
																							  <asp:TextBox ID="txtDescripcion" runat="server" class="form-control" TextMode="MultiLine" Rows="4" MaxLength="500"></asp:TextBox>
																					</ContentTemplate>
																...
																<div class="card shadow-sm">
																	<div class="card-body">
																		<h6 class="" style="color: #860264">Detalle de pedido</h6>
																			<br />
																			<label>Por cuál fue atendido(*):</label>
																				<asp:UpdatePanel ID="UpdatePanel13" runat="server">
																				<ContentTemplate>
                                                  								<asp:DropDownList ID="cbocanalPedido" runat="server" class="form-select"></asp:DropDownList>
																				</ContentTemplate>
																				</asp:UpdatePanel>
																			<br />

																			<div class="form-group">
																				<label>Pedido del Consumidor (Indique aquí lo que solicita)(*): :</label>
																				<asp:UpdatePanel ID="UpdatePanel6" runat="server">
																					<ContentTemplate>
																							  <asp:TextBox ID="txtPedido" runat="server" class="form-control" AutoPostBack="True" TextMode="MultiLine" Rows="4" MaxLength="500"></asp:TextBox>
																					</ContentTemplate>
																	...
																	<div class="modal-content">
																		<div class="modal-body">
																			<div class="text-center">
																				...
																				<h5><span class="modal-text"><asp:Label ID="Label2" runat="server" Text="Registrando Caso... " ForeColor="#666666"></asp:Label></span></h5>
																			</div>
																		</div>
																	</div>
																</div>
