<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="admin_documentos.aspx.vb" Inherits="AdminLReclamaciones.admin_documentos" %>
											...
											<div class="menu-wrapper menu-column menu-fit">
												...
												<div class="menu-item">
													...
													<div class="menu-sub menu-fit menu-sub-accordion show pb-10">
														...
														<div class="menu-item">
															<a class="menu-link py-2" href="mis_evaluaciones.aspx">
...
<%--												<div class="menu-item">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-xxl d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center">
								<!--begin::Title-->
								<h3 class="text-dark fw-bolder my-1 fs-2">Administración de Reclamaciones</h3>
								<!--end::Title-->
							</div>
					...
					<div class="d-flex flex-column flex-column-fluid">
								...
								<form class="form d-flex justify-content-center" runat="server">
												...
												<div class="container">
													...
													<div class="row g-3 mb-4">
														<div class="col-sm-6 col-md-3">
															<a href="#" class="card bg-light-danger hoverable min-h-125px shadow-none">
																<div class="card-body d-flex flex-column flex-center">
																	<h3 class="fs-3 mb-2 text-dark text-hover-danger fw-bolder">Pendientes</h3>
																	<p class="mb-0 text-gray-600"><asp:Label ID="lblcan1" runat="server" Text="0"></asp:Label></p>
																</div>
															</a>
														</div>
														<div class="col-sm-6 col-md-3">
															<a href="#" class="card bg-light-warning hoverable min-h-125px shadow-none">
																<div class="card-body d-flex flex-column flex-center text-center">
																	<h3 class="fs-3 mb-2 text-dark text-hover-danger fw-bolder">En Atención</h3>
																	<p class="mb-0 text-gray-600"><asp:Label ID="lblcan2" runat="server" Text="0"></asp:Label></p>
																</div>
															</a>
														</div>
														<div class="col-sm-6 col-md-3">
															<a href="#" class="card bg-light-primary hoverable min-h-125px shadow-none">
																<div class="card-body d-flex flex-column flex-center text-center">
																	<h3 class="fs-3 mb-2 text-dark text-hover-danger fw-bolder">Finalizados</h3>
																	<p class="mb-0 text-gray-600"><asp:Label ID="lblcan3" runat="server" Text="0"></asp:Label></p>
																</div>
															</a>
														</div>
														<div class="col-sm-6 col-md-3">
															<a href="#" class="card bg-light-dark hoverable min-h-125px shadow-none">
																<div class="card-body d-flex flex-column flex-center text-center">
																	<h3 class="fs-3 mb-2 text-dark text-hover-danger fw-bolder">Rechazados</h3>
																	<p class="mb-0 text-gray-600"><asp:Label ID="lblcan4" runat="server" Text="0"></asp:Label></p>
																</div>
															</a>
														</div>
													</div>
													...
													<div class="row g-3">
														...
														<div class="col-md-6">
															<div class="row mb-3">
																<label class="col-lg-4 col-form-label" style="color: #860264">Seleccione Unidad:</label>
																<div class="col-lg-8">
																	<asp:UpdatePanel ID="UpdatePanel3" runat="server">
																		<ContentTemplate>
																			<asp:DropDownList ID="cbounidad" runat="server" class="form-select" AutoPostBack="True"></asp:DropDownList>
																		</ContentTemplate>
																	</asp:UpdatePanel>
															...
															<div class="row mb-3">
																<label class="col-lg-4 col-form-label" style="color: #860264">DNI Cliente:</label>
																<div class="col-lg-8">
																	<asp:Panel ID="Panel4" runat="server">
																		 <asp:TextBox ID="txtdnicliente" runat="server" aria-describedby="basic-addon1" class="form-control"></asp:TextBox>
																	</asp:Panel>
																</div>
															</div>

															<div class="row mb-3">
																<label class="col-lg-4 col-form-label" style="color: #860264">Estado del Caso:</label>
																<div class="col-lg-7">
																	<asp:UpdatePanel ID="UpdatePanel4" runat="server">
																	<ContentTemplate>
																	<asp:DropDownList ID="cboestados" runat="server" class="form-select" AutoPostBack="True"></asp:DropDownList>
																	</ContentTemplate>
																	</asp:UpdatePanel>
																</div>
																<div class="col-lg-1">
																<asp:LinkButton ID="btnbuscar" runat="server" class="btn btn-icon btn-primary me-2 mb-2" ToolTip="Buscar Quejas o Reclamos"><i class="las la-search fs-2"></i></asp:LinkButton>
																</div>
															</div>
														</div>
														...
														<div class="col-md-6">
															<div class="row mb-3">
																<label class="col-lg-4 col-form-label" style="color: #860264">Fecha Inicio:</label>
																<div class="col-lg-8">
																	<asp:Panel ID="Panel5" runat="server">
																		<asp:TextBox ID="txtfecIni" runat="server" class="form-control" type="date"></asp:TextBox>
																	</asp:Panel>
																</div>
															</div>

															<div class="row mb-3">
																<label class="col-lg-4 col-form-label" style="color: #860264">Fecha Fin:</label>
																<div class="col-lg-8">
																	<asp:Panel ID="Panel6" runat="server">
																		<asp:TextBox ID="txtfecFin" runat="server" class="form-control" type="date"></asp:TextBox>
																	</asp:Panel>
																</div>
															</div>
														</div>
													...
													<asp:UpdatePanel ID="UpdatePanel1" runat="server">
														<ContentTemplate>
																<asp:GridView ID="grvDocumentos" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover">
																<Columns>
						
																	<asp:TemplateField HeaderText="Acciones">
																		<HeaderStyle CssClass="fw-bolder fs-6 text-gray-800 border-bottom border-gray-200 text-center" />
																		<ItemStyle CssClass="text-center align-middle" />
																		<ItemTemplate>
																			<asp:LinkButton ID="btnAtender" runat="server" CommandName="atender" CommandArgument='<%# Bind("nro_documento") %>' 
																				CssClass="btn btn-icon btn-info btn-sm" ToolTip="Atender">
																	...
																	<asp:TemplateField HeaderText="Documento">
																		...
																		<ItemTemplate>
																			<asp:UpdatePanel ID="UpdatePanel5" runat="server">
																				<ContentTemplate>
																					<asp:Label ID="lblnrodocumento" runat="server" Text='<%# Bind("nro_documento") %>' CssClass="text-dark fw-semibold" ToolTip="Documento de Reclamo del Cliente"></asp:Label>
																				</ContentTemplate>
																			</asp:UpdatePanel>
																		</ItemTemplate>
																	</asp:TemplateField>
																	...
																	<asp:TemplateField HeaderText="Unidad">
																		...
																		<ItemStyle CssClass="text-center align-middle" />
																		<ItemTemplate>
																			<asp:UpdatePanel ID="UpdatePanel_nombre_completo" runat="server">
																				<ContentTemplate>
																					<asp:Label ID="lbldescunidad" runat="server" Text='<%# Bind("desc_unidad") %>' CssClass="text-dark fw-semibold" ToolTip=""></asp:Label>
																				</ContentTemplate>
																			</asp:UpdatePanel>
																		</ItemTemplate>
																	</asp:TemplateField>
																	<asp:TemplateField HeaderText="Fecha Registro">
																		...
																		<ItemStyle CssClass="text-center align-middle" />
																		<ItemTemplate>
																			<asp:UpdatePanel ID="UpdatePanel_nombre_completoxx" runat="server">
																				<ContentTemplate>
																					<asp:Label ID="lblfecharegistro" runat="server" Text='<%# Bind("fecha_registro") %>' CssClass="text-dark fw-semibold" ToolTip=""></asp:Label>
																				</ContentTemplate>
																			</asp:UpdatePanel>
																		</ItemTemplate>
																	</asp:TemplateField>
		
																	<asp:TemplateField HeaderText="Nombre del Consumidor">
																		<HeaderStyle CssClass="fw-bolder fs-6 text-gray-800 border-bottom border-gray-200 text-center" />
																		<ItemStyle CssClass="text-center align-middle" />
																		<ItemTemplate>
																			<asp:UpdatePanel ID="UpdatePanel_nombre_completo1" runat="server">
																				<ContentTemplate>
																					<asp:Label ID="lblnom_consumidor" runat="server" Text='<%# Bind("nom_consumidor") %>' CssClass="text-dark fw-semibold" ToolTip=""></asp:Label>
																				</ContentTemplate>
																			</asp:UpdatePanel>
																		</ItemTemplate>
																	</asp:TemplateField>

																	<asp:TemplateField HeaderText="Dias Hábiles">
																		<HeaderStyle CssClass="fw-bolder fs-6 text-gray-800 border-bottom border-gray-200 text-center" />
																		<ItemStyle CssClass="text-center align-middle" />
																		<ItemTemplate>
																			<asp:UpdatePanel ID="UpdatePanel_nombre_completod" runat="server">
																				<ContentTemplate>
																					<asp:Label ID="lbldias_transcurridos" runat="server" Text='<%# Bind("Dias_Transcurridos") %>' CssClass="text-dark fw-semibold" ToolTip=""></asp:Label>
																				</ContentTemplate>
																			</asp:UpdatePanel>
																		</ItemTemplate>
																	</asp:TemplateField>
																	...
																	<asp:TemplateField HeaderText="Carta">
																		...
																		<ItemStyle CssClass="text-center align-middle" />
																		<ItemTemplate>
																			<asp:UpdatePanel ID="UpdatePanel_nombre_completo2x" runat="server">
																				<ContentTemplate>
																					<asp:Label ID="lblenvio_carta" runat="server" Text='<%# Bind("carta_enviada") %>' CssClass="text-dark fw-semibold" ToolTip=""></asp:Label>
																				</ContentTemplate>
																			</asp:UpdatePanel>
																		</ItemTemplate>
																	</asp:TemplateField>

																	<asp:TemplateField HeaderText="Fecha A. Gerente">
																		<HeaderStyle CssClass="fw-bolder fs-6 text-gray-800 border-bottom border-gray-200 text-center" />
																		<ItemStyle CssClass="text-center align-middle" />
																		<ItemTemplate>
																			<asp:UpdatePanel ID="UpdatePanel_nombre_completo2" runat="server">
																				<ContentTemplate>
																					<asp:Label ID="lblfecha_aprob_gerente" runat="server" Text='<%# Bind("fecha_final") %>' CssClass="text-dark fw-semibold" ToolTip=""></asp:Label>
																				</ContentTemplate>
																			</asp:UpdatePanel>
																		</ItemTemplate>
																	</asp:TemplateField>
																	...
																	<asp:TemplateField HeaderText="Estado">
																		...
																		<ItemStyle CssClass="text-center align-middle" />
																		<ItemTemplate>
																			<asp:UpdatePanel ID="UpdatePanel_nombre_completo3" runat="server">
																				<ContentTemplate>
																					<asp:Label ID="lblid_estado" runat="server" Text='<%# Bind("id_Estado") %>' Visible="False"></asp:Label>
																					<asp:Label ID="lblestado_pendiente"  runat="server" Text='<%# Bind("Estado") %>' CssClass="badge bg-danger text-white custom-label"  Visible="False"></asp:Label>
																					<asp:Label ID="lblestado_adminUnidad" runat="server" Text='<%# Bind("Estado") %>' CssClass="badge bg-warning text-white custom-label" Visible="False"></asp:Label>
																					<asp:Label ID="lblestado_legal" runat="server" Text='<%# Bind("Estado") %>' CssClass="badge bg-warning text-white custom-label" Visible="False"></asp:Label>
																					<asp:Label ID="lblestado_Rlegal" runat="server" Text='<%# Bind("Estado") %>' CssClass="badge bg-danger text-white custom-label" Visible="False"></asp:Label>
																					<asp:Label ID="lblestado_GerenteMarca" runat="server" Text='<%# Bind("Estado") %>' CssClass="badge bg-success text-white custom-label" Visible="False"></asp:Label>
																					<asp:Label ID="lblestado_RGerenteMarca" runat="server" Text='<%# Bind("Estado") %>' CssClass="badge bg-danger text-white custom-label" Visible="False"></asp:Label>
																					<asp:Label ID="lblestado_anuladofisico" runat="server" Text='<%# Bind("Estado") %>' CssClass="badge bg-success text-white custom-label" Visible="False"></asp:Label>
																				</ContentTemplate>
																			</asp:UpdatePanel>
																		</ItemTemplate>
																	</asp:TemplateField>
                                    ...
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-header" style="background-color: #FFFFFF; color: #860264;">
                                                <h2 class="modal-title" id="myLargeModalLabel">
                                                    <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                                                        <ContentTemplate>
                                                         <asp:Label ID="lbltituloCasos" runat="server" Text="Sorprendenos con nuestros Valores" ForeColor="#860264"></asp:Label>
                                            ...
                                            <div class="modal-body">
                                                  <br />
													<div class="row">
														<img src="images/images_sistema/imagen_popup.png" />
													</div>
                                                    <div class="row">
                                                    <!-- Column -->
                                                    <div class="col-lg-12">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-6">
                                                                        <p>
																			<asp:Label ID="Label3" runat="server" Text="Aquí puedes reconocer a todos los compañeros que diariamente viven nuestros valores con gran pasión." ForeColor="#860264" Font-Size="Larger"></asp:Label>
																		</p>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="text-center">
                                                            ...
                                                            <h5><span class="modal-text"><asp:Label ID="Label2" runat="server" Text="Registrando Reconocimiento..." ForeColor="#666666"></asp:Label></span></h5>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
						...
						<script>
                            ...
                            //$("#txtfecinisancion").daterangepicker();
       //                     $("#txtfecinisancion").daterangepicker({
       ...
       //                     $("#txtfecfinsancion").daterangepicker({
       //                         singleDatePicker: true,
       //                         showDropdowns: true,
       //                         minYear: 1901,
       //                         maxYear: parseInt(moment().format("YYYY"), 10)
