<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Detalle_Admin_Documento_F.aspx.vb" Inherits="AdminLReclamaciones.Detalle_Admin_Documento_F" %>
														...
														<div class="row">
															...
															<div class="col-lg-4">
																...
																<div class="card-body">
																		...
																		<div class="d-flex justify-content-between align-items-center mb-3">
																			...
																			<asp:Label ID="lbldesc_estado" runat="server" Text="Label" Visible="False"></asp:Label>
																			 ...
																			 <asp:Label ID="lblestado_RGerenteMarca" runat="server" Text="" class="label label-danger" Visible="False"></asp:Label>
																				<asp:Label ID="lblnombreusuario" runat="server" Text="Ivan Martinez" Visible="False"></asp:Label>
																		...
																		<asp:Panel ID="pnleditables2" runat="server">
																		...
																		<div class="mb-3">
																			...
																			<p class="text-muted">
																				<%--<asp:Label ID="lblnomcliente" runat="server" Text="Ivan Martinez"></asp:Label>--%>
																				<asp:TextBox ID="txtnomcliente" runat="server" class="form-control"></asp:TextBox>
																			</p>
																		...
																		<div class="mb-3">
																			...
																			<p class="text-muted">
																				<%--<asp:Label ID="lbldnicliente" runat="server" Text="43198858"></asp:Label>--%>
																				<asp:TextBox ID="txtdnicliente" runat="server" class="form-control"></asp:TextBox>
																			</p>
																		</div>
																		...
																		<div class="mb-3">
																			...
																			<p class="text-muted">
																				<%--<asp:Label ID="lbldireccioncliente" runat="server" Text="av. abc 345"></asp:Label>--%>
																				<asp:TextBox ID="txtdireccioncliente" runat="server" class="form-control"></asp:TextBox>
																			</p>
																		</div>
																		...
																		<div class="mb-3">
																			...
																			<p class="text-muted">
																				<%--<asp:Label ID="lbltelefono_email" runat="server" Text="999652464 / abc@aaaa.com"></asp:Label>--%>
																				<asp:TextBox ID="txttelefono_email" runat="server" class="form-control"></asp:TextBox>
																			</p>
																		</div>
																		<div class="mb-3">
																			<strong>Email:</strong>
																		...
																		<div class="card-body p-0">
																			...
																			<div class="overlay rounded overflow-hidden">
																				<div class="overlay-wrapper rounded bg-light text-center">
																					<%--<img src="theme/dist/assets/media/products/1.png" alt="" class="mw-100 w-200px" />--%>
																					<asp:UpdatePanel ID="UpdatePanel_imgfisico" runat="server">
																					<ContentTemplate>
																					<asp:Image ID="img_documento_fisico" runat="server" AlternateText="" CssClass="mw-100 w-200px"/>
																					</ContentTemplate>
																					</asp:UpdatePanel>

																				</div>
																				<div class="overlay-layer">
																					<%--<a href="theme/dist/apps/shop/product.html" class="btn fw-bolder btn-sm btn-primary me-2">Quick View</a>--%>
																					<asp:LinkButton ID="btnDescargarImagen" runat="server" CssClass="btn fw-bolder btn-sm btn-primary me-2" Text="Descargar imagen"></asp:LinkButton>
																			...
																			<div class="text-center mt-5 mb-md-0 mb-lg-5 mb-md-0 mb-lg-5 mb-lg-0 mb-5 d-flex flex-column">
																				<%--<a href="../dist/apps/shop/product.html" class="fs-4 fw-bolder text-gray-800 text-hover-primary mb-1">Fotografía del Documento de Reclamo</a>--%>
																				<span class="fs-6">Fotografía del Documento</span>
																				<asp:Label ID="lblnombreimagen" runat="server" Text="" Visible="False"></asp:Label>
																			</div>
																			<!--end::Details-->
																		</div>
																	</div>
																	...
																	<div class="card-body">
																		...
																		<div class="form-group" >
																			<asp:UpdatePanel ID="UpdatePanel10" runat="server">
																				<ContentTemplate>
																					<asp:CheckBox ID="chkanulado_fisico" runat="server" Text="Documento Anulado (Ingrese el Sustento de Anulación)" AutoPostBack="True"  CssClass="custom-checkbox-list"/>
																				</ContentTemplate>
																			</asp:UpdatePanel>
                                                       					</div>   
																		</p>

													<%--					<label>Ingrese el sustento de anulación:</label>--%>
																		<div class="form-group" >
																				<asp:UpdatePanel ID="UpdatePanel9" runat="server">
																					<ContentTemplate>
																						<asp:TextBox ID="txtsustentoanulacion" runat="server" class="form-control" MaxLength="500" TextMode="MultiLine" Rows="5" Visible="False"></asp:TextBox>
																					</ContentTemplate>
																				</asp:UpdatePanel>
																		...
																		<asp:Panel ID="pnleditables1" runat="server"> 
																			...
																			<div class="row">
																				...
																				<!-- Fila 2: Identificación del bien contratado -->
																				<div class="col-md-6">
																					<div class="mb-3">
																				...
																				<div class="col-md-6">
																					<div class="mb-3">
																						<asp:TextBox ID="txtmonto_reclamado" runat="server" class="form-control"></asp:TextBox>
																					</div>
																				</div>

																				<!-- Fila 4: Descripción del Bien Contratado -->
																				<div class="col-md-6">
																					<div class="mb-3">
																						<strong>Descripción del Bien Contratado:</strong>
																					</div>
																				</div>
																				<div class="col-md-6">
																					<div class="mb-3">
																						<asp:TextBox ID="txtdesc_biencontratado" runat="server" class="form-control"></asp:TextBox>
																					</div>
																				</div>
																			</div>
																			...
																			<div class="d-flex align-items-start">
																				...
																				<div>
																					...
																					<p class="text-muted mt-2">
																						...
																						<asp:TextBox ID="txtdetalle_reclamo_queja" runat="server" class="form-control" TextMode="MultiLine" Rows="4" MaxLength="500"></asp:TextBox>
																			...
																			<div class="d-flex align-items-start">
																				...
																				<div>
																					...
																					<p class="text-muted mt-2">
																						...
																						<asp:TextBox ID="txtdetalle_canal_pedido" runat="server" class="form-control" TextMode="MultiLine" Rows="4" MaxLength="500"></asp:TextBox>
																					</p>
																				</div>
																			</div>
																				...
																				<div class="col-12 mb-3">
																					<div class="d-flex align-items-start">
																						...
																						<div class="w-100">
																							<strong>Detalle de la Reclamación y pedido del consumidor:</strong>
																							<p class="text-muted mt-2">
																								<asp:TextBox ID="txtdetalle_reclamo_queja" runat="server" class="form-control" 
																				...
																				<div class="col-12 mb-3">
																					<div class="d-flex align-items-start">
																						...
																						<div class="w-100">
																							<strong>Pedido de parte del Cliente:</strong>
																							<p class="text-muted mt-2">
																								<asp:TextBox ID="txtdetalle_canal_pedido" runat="server" class="form-control" 
																												TextMode="MultiLine" Rows="4" MaxLength="500"></asp:TextBox>
																							</p>
																						</div>
																					</div>
