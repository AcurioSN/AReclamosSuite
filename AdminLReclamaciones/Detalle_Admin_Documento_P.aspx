<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Detalle_Admin_Documento_P.aspx.vb" Inherits="AdminLReclamaciones.Detalle_Admin_Documento_P" %>
							...
							<div class="container-xxl">
								<form class="form d-flex justify-content-center" runat="server">
									...
									<div class="card container">
										...
										<%--Modal Popup--%>
										<div id="myModalxxxx" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                                            ...
                                            <div class="modal-header" style="background-color: #A8123E; color: #FFFFFF;">
                                                <h4 class="modal-title" id="myLargeModalLabel">
                                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                        <ContentTemplate>
                                                         <h5 class="modal-title" id="vcenter" style="color: #FFFFFF"><asp:Label ID="Label1" runat="server" Text="Archivos Adjuntos por el Proveedor"></asp:Label></h5>
