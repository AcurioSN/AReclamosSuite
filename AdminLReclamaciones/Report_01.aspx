<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report_01.aspx.vb" Inherits="AdminLReclamaciones.Report_01" %>
										...
										<div class="hover-scroll-y pe-4 pe-lg-5" id="kt_aside_menu_scroll" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_wordspace" data-kt-scroll-offset="10px">
											<div class="menu-wrapper menu-column menu-fit">
												<div class="menu-item here show">
													<h4 class="menu-content text-muted mb-0 fs-6 fw-bold text-uppercase">MS</h4>
												...
												<div class="container">
													...
													<%--<div class="row g-3 mb-4">
													 ...
													 <div class="container mt-5">
																...
																<%--	<asp:LinkButton ID="btnlimpiar" runat="server" CssClass="icon-button">
																	  <i class="fas fa-trash-restore"></i>
																	  <span class="icon-text">Limpiar</span>
																	</asp:LinkButton>--%>

																	<asp:LinkButton ID="btnexcel" runat="server" CssClass="icon-button">
																	  <i class="fas fa-file-excel"></i>
																	  <span class="icon-text">Exportar</span>
																	</asp:LinkButton>

																	<asp:LinkButton ID="btnexcel_analisis" runat="server" CssClass="icon-button">
																	  <i class="fas fa-file-excel"></i>
																	  <span class="icon-text">Exportar Análisis</span>
																	</asp:LinkButton>

																	<asp:LinkButton ID="btnTxt" runat="server" CssClass="icon-button">
																	  <i class="fas fa-file-archive"></i>
																	  <span class="icon-text">Indecopi TXT</span>
																	</asp:LinkButton>

																	<asp:LinkButton ID="btnPWBI" runat="server" CssClass="icon-button">
																	  <i class="fas fa-database"></i>
																	  <span class="icon-text">Power BI</span>
																	</asp:LinkButton>
																  </div>
																</div>
													...
													<div class="row g-3">
														...
														<div class="col-md-6">
															...
															<div class="row mb-3">
																<label class="col-lg-4 col-form-label" style="color: #860264">Tipo:</label>
																<div class="col-lg-7">
																	<asp:UpdatePanel ID="UpdatePanel4" runat="server">
																	<ContentTemplate>
																	<asp:DropDownList ID="cbotipo" runat="server" class="form-select" AutoPostBack="False"></asp:DropDownList>
																	</ContentTemplate>
																	</asp:UpdatePanel>
																</div>
																<div class="col-lg-1">
													...
													<asp:UpdatePanel ID="UpdatePanel1" runat="server">
														<ContentTemplate>
																<asp:GridView ID="grvResultado" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover">
																<Columns>
																	...
																	<asp:TemplateField HeaderText="Nombre Consumidor">
																		<HeaderStyle CssClass="fw-bolder fs-6 text-gray-800 border-bottom border-gray-200 text-center" />
																		<ItemStyle CssClass="text-center align-middle" />
																		<ItemTemplate>
																			<asp:UpdatePanel ID="UpdatePanel_nombre_completoxx" runat="server">
																				<ContentTemplate>
																					<asp:Label ID="lblnomconsumidor" runat="server" Text='<%# Bind("nom_consumidor") %>' CssClass="text-dark fw-semibold" ToolTip=""></asp:Label>
																				</ContentTemplate>
																			</asp:UpdatePanel>
																		</ItemTemplate>
																	</asp:TemplateField>
		
																	<asp:TemplateField HeaderText="Dni Consumidor">
																		<HeaderStyle CssClass="fw-bolder fs-6 text-gray-800 border-bottom border-gray-200 text-center" />
																		<ItemStyle CssClass="text-center align-middle" />
																		<ItemTemplate>
																			<asp:UpdatePanel ID="UpdatePanel_nombre_completo1" runat="server">
																				<ContentTemplate>
																					<asp:Label ID="lbldniconsumidor" runat="server" Text='<%# Bind("dni_consumidor") %>' CssClass="text-dark fw-semibold" ToolTip=""></asp:Label>
																				</ContentTemplate>
																			</asp:UpdatePanel>
																		</ItemTemplate>
																	</asp:TemplateField>
																	...
																	<asp:TemplateField HeaderText="Teléfono">
																		...
																		<ItemTemplate>
																			<asp:UpdatePanel ID="UpdatePanel_nombre_completod" runat="server">
																				<ContentTemplate>
																					<asp:Label ID="lbltelefono" runat="server" Text='<%# Bind("telef_consumidor") %>' CssClass="text-dark fw-semibold" ToolTip=""></asp:Label>
																				</ContentTemplate>
																			</asp:UpdatePanel>
																		</ItemTemplate>
																	</asp:TemplateField>

																	<asp:TemplateField HeaderText="Reclamo/Queja">
																		<HeaderStyle CssClass="fw-bolder fs-6 text-gray-800 border-bottom border-gray-200 text-center" />
																		<ItemStyle CssClass="text-center align-middle" />
																		<ItemTemplate>
																			<asp:UpdatePanel ID="UpdatePanel_nombre_completo2x" runat="server">
																				<ContentTemplate>
																					<asp:Label ID="lblreclamoqueja" runat="server" Text='<%# Bind("reclamo_queja") %>' CssClass="text-dark fw-semibold" ToolTip=""></asp:Label>
																				</ContentTemplate>
																			</asp:UpdatePanel>
																		</ItemTemplate>
																	</asp:TemplateField>
                                    ...
                                    <!-- /.modal-dialog -->
										...
										<div class="modal fade" tabindex="-1" id="myModal_busqueda">
											...
											<%--			<asp:LinkButton ID="btncerrar1" runat="server" class="btn btn-light" data-bs-dismiss="modal fade">LinkButton</asp:LinkButton>
														...
														<ContentTemplate>
																			  <asp:Label ID="lblcan" runat="server" Text="0"></asp:Label>
														</ContentTemplate>
													</asp:UpdatePanel>
