<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="main.aspx.vb" Inherits="AdminLReclamaciones.main" %>
...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<meta name="description" content="Sistema AReclamos - Acurio Restaurantes" />
		<meta name="keywords" content="Sistema de Administración de Quejas y Reclamos en Acurio Restaurantes" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta property="og:locale" content="en_US" />
		<meta property="og:type" content="article" />
		<meta property="og:title" content="Sistema AReclamos" />
										...
										<div class="hover-scroll-y pe-4 pe-lg-5" id="kt_aside_menu_scroll" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_wordspace" data-kt-scroll-offset="10px">
											<div class="menu-wrapper menu-column menu-fit">
												...
												<div class="menu-item">
													...
													<div class="menu-sub menu-fit menu-sub-accordion show pb-10">
														<div class="menu-item">
															<a class="menu-link py-2" href="admin_documentos.aspx">
					...
					<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-xxl d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center">
								<!--begin::Title-->
								<h3 class="text-dark fw-bolder my-1 fs-2">Sistema AReclamos</h3>
								<!--end::Title-->
							</div>
							<!--end::Left-->
							<!--begin::Right-->
								...
								<div class="ms-1 ms-lg-6">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold w-300px" data-kt-menu="true">
										...
										<div class="row row-cols-2 g-0">
											<a href="main.aspx" class="border-bottom border-end text-center py-10 btn btn-active-color-primary rounded-0">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
												...
												<!--end::Svg Icon-->
												<span class="fw-bolder fs-6 d-block pt-3">Mi Perfil</span>
											</a>
						...
						<div class="content fs-6 d-flex flex-column-fluid" id="kt_content">
							...
							<div class="row g-0 g-xl-5 g-xxl-8">
								<div class="col-xl-4">
									...
									<div class="card card-stretch mb-5 mb-xxl-8" style="background-color: #d8262f">
										<!--begin::Body-->
										<div class="card-body">
											<!--begin::Section-->
											<div class="d-flex align-items-center">
												...
												<!--begin::Title-->
												<div>
													<a href="main.aspx" class="fs-4 text-white text-hover-primary fw-bolder">Pendientes o Rechazadas</a>
													<%--<div class="fs-7 text-white fw-bold mt-1">Pendientes de Aprobación</div>--%>
												</div>
												<!--end::Title-->
											</div>
											<!--end::Section-->
											<!--begin::Info-->
											<div class="fw-bolder text-white pt-7" style="text-align: center">
												<span class="d-block"><asp:Label ID="lblpendientes" runat="server" Text="0"></asp:Label></span>
											<%--	<span class="d-block pt-2">0 Aprobadas</span>--%>
											</div>
											<!--end::Info-->
											<!--begin::Progress-->
								...
								<div class="col-xl-4">
									...
									<div class="card card-stretch mb-5 mb-xxl-8" style="background-color: #7f0164">
										<!--begin::Body-->
										<div class="card-body">
											<!--begin::Section-->
											<div class="d-flex align-items-center">
												...
												<!--begin::Title-->
												<div>											
													<a href="main.aspx" class="fs-4 text-white text-hover-primary fw-bolder">En atención</a>
													<%--<div class="fs-7 text-white fw-bold mt-1">Sanciones Directas</div>--%>
												</div>
												<!--end::Title-->
											</div>
											<!--end::Section-->
											<!--begin::Info-->
											<div class="fw-bolder text-white pt-7" style="text-align: center">
												<span class="d-block"><asp:Label ID="lblsancionesgeneral" runat="server" Text="0"></asp:Label></span>
								...
								<div class="col-xl-4">
									...
									<div class="card card-stretch mb-5 mb-xxl-8" style="background-color: #cb017b">
										<!--begin::Body-->
										<div class="card-body">
											<!--begin::Section-->
											<div class="d-flex align-items-center">
												...
												<!--begin::Title-->
												<div>
													<a href="main.aspx" class="fs-4 text-white text-hover-primary fw-bolder">Resueltos</a>
													<%--<div class="fs-7 text-white fw-bold mt-1">Sanciones registradas</div>--%>
												</div>
												<!--end::Title-->
											</div>
											<!--end::Section-->
											<!--begin::Info-->
											<div class="fw-bolder text-white pt-7" style="text-align: center">
												  <span class="d-block"><asp:Label ID="lblregistradas" runat="server" Text="0"></asp:Label></span>
									<%--			<span class="d-block pt-2">140 Comments</span>--%>
											</div>
											<!--end::Info-->
											<!--begin::Progress-->
							...
							<br>
								...
								<div class="row g-5 g-xxl-8">
											<div class="col-md-8 col-lg-12 col-xxl-8">
												...
												<div class="card mb-5 mb-xxl-8 overflow-hidden" >
													<div class="card-body p-0 d-flex card-rounded" style="background-color: #E9DAC7">
														<div class="py-18 px-12">
															<h3 class="fs-2x">
																<a href="admin_documentos.aspx" class="text-black text-hover-primary fw-bolder">Administrador de Reclamos</a>
															</h3>
															<div class="fs-3 text-black">Administra tus quejas y reclamos</div>
														</div>
														<div class="d-none d-md-flex flex-row-fluid bgi-no-repeat bgi-position-y-center bgi-position-x-right bgi-size-cover" style="transform: translateX(10%) rotate(-26deg); background-image: url('images/images_sistema/admin_sancion.png')"></div>
													</div>
												</div>
												<!--end::Engage Widget 2-->
												<!--begin::Engage Widget 2-->
												<div class="card mb-0 mb-md-5 mb-lg-0 mb-xxl-8 overflow-hidden">
													<div class="card-body p-0 d-flex card-rounded bg-light-danger">
														<div class="py-18 px-12">
															<h3 class="fs-2x">
																<a href="Nuevo_Reclamo.aspx" class="text-black text-hover-primary fw-bolder">Reclamo Físico</a>
															</h3>
															<div class="fs-3 text-black">Registra un reclamo físico</div>
														</div>
														<div class="d-none d-md-flex flex-row-fluid bgi-no-repeat bgi-position-y-center bgi-position-x-right bgi-size-cover" style="transform: translateX(10%) rotate(-26deg); background-image: url('images/images_sistema/nuevo_sancion.png')"></div>
													</div>
												</div>
												<!--end::Engage Widget 2-->
											</div>
											<div class="col-md-4 col-lg-12 col-xxl-4">
												...
												<div class="card card-stretch mb-5 mb-xxl-8">
													<div class="card-body d-flex flex-column rounded justify-content-between" style="background-color: #E9DAC7">
														<div class="rounded text-center mb-7 pt-7">
															<img src="images/images_sistema/reporte_excel.png" class="mw-100 w-200px" alt="img" style="transform: scale(1.4);" />
														</div>
														<div class="text-center">
															<h3 class="fs-2x">
																<a href="Report_01.aspx" class="text-black text-hover-primary fw-bolder" target="_blank">Reporte</a>
															</h3>
															<%--<div class="fs-3 text-success">Accede al Reporte General</div>--%>
															<div class="fs-3 text-black">Accede al Reporte General</div>
														</div>
													</div>
												</div>
								...
								<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
									...
									<div class="container-xxl d-flex flex-column flex-md-row flex-stack">
										...
										<div class="text-dark order-2 order-md-1">
											<span class="text-muted fw-bold me-2">Desarrollo de Sistemas</span>
